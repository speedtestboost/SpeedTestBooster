...
export default function DelhiSpeedTest() {
  ...
  useEffect(() => {
    ...
    // Open Graph tags
    const ogTags = [
      { property: 'og:title', content: 'Delhi Internet Internet Speed Test - Free WiFi & Broadband Speed Checker NCR' },
    ...
    const twitterTags = [
      ...
      { name: 'twitter:title', content: 'Delhi Internet Internet Speed Test - Free WiFi & Broadband Speed Checker NCR' },
    ...
    structuredData.textContent = JSON.stringify({
      ...
      "@type": "WebApplication",
      "name": "Delhi Internet Internet Speed Test",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-4xl mx-auto px-4 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl lg:text-4xl font-bold mb-4 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
            Delhi NCR Internet Internet Speed Test
          </h1>
      ...
      <main className="max-w-md lg:max-w-7xl mx-auto px-4 lg:px-8 py-6 space-y-6">
        <Breadcrumbs 
          items={[
            { label: "Delhi Internet Speed Test", href: "/delhi-speed-test" }
          ]} 
        />
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              ...
              <Link href="/kolkata-speed-test" className="block p-4 bg-background/50 hover:bg-primary/10 rounded-lg border border-border/50 hover:border-primary/20 transition-all duration-200">
                ...
                <div className="text-xs text-muted-foreground">East India Internet Speed Test</div>
              </Link>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-card/30 backdrop-blur-sm border-t border-border/50 mt-12">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12">
          ...
          <div className="text-center pt-8 border-t border-border/30 mt-8">
            <p className="text-sm text-muted-foreground">
              © 2026 Internet Speed Test and Boost. Free internet speed booster test Delhi tool for accurate bandwidth measurement. 
