...
export default function CASpeedTest() {
      ...
      <section className="bg-card/30 backdrop-blur-sm border-t border-border/50 mt-12">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            <Card className="card-hover">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  Our Canadian servers provide precise measurements for fibre, cable, DSL, and WiFi connections.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="card-hover">
              <CardContent className="p-6">
                <h2 className="text-lg font-semibold text-foreground mb-3">Major Canadian Internet Providers</h2>
                <div className="space-y-2 text-sm text-muted-foreground">
                  <div><strong className="text-foreground">Rogers:</strong> Cable and fibre up to 1500 Mbps</div>
                  <div><strong className="text-foreground">Bell:</strong> Fibe fibre speeds up to 1500 Mbps</div>
                  <div><strong className="text-foreground">Telus:</strong> PureFibre up to 2500 Mbps</div>
                  <div><strong className="text-foreground">Shaw:</strong> Cable speeds up to 1000 Mbps</div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="card-hover">
              <CardContent className="p-6">
                ...
                <div className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <div><strong className="text-foreground">BC:</strong> Vancouver, Victoria</div>
                  <div><strong className="text-foreground">Alberta:</strong> Calgary, Edmonton</div>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-foreground mb-2">Accurate Canadian Measurements</h4>
                  <p className="text-sm text-muted-foreground">
                    Our speed test uses multiple Canadian-based servers to provide the most accurate internet speed 
                    measurements for Canadian users. Test your connection against servers from coast to coast.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-foreground mb-2">All Major Canadian ISPs Supported</h4>
                  <p className="text-sm text-muted-foreground">
                    Whether you're using Rogers, Bell, Telus, Shaw, Videotron, or any other Canadian internet provider, 
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="font-semibold text-foreground mb-2">Optimize Your Canadian Connection</h4>
                  <p className="text-sm text-muted-foreground">
                    Get personalized recommendations to improve your internet speed based on your Canadian location 
                    and ISP. Learn how to optimize your home network for better performance across the Great White North.
                  </p>
                </div>
              </div>
            </div>
