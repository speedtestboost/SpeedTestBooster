...
export default function CenturyLinkSpeedTest() {
  ...
  useEffect(() => {
    ...
    canonical.href = 'https://speedtestboost.com/providers/us/centurylink';
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      ...
      <main className="pt-24 pb-12">
        <div className="max-w-4xl mx-auto px-4 lg:px-8">
          <Breadcrumbs 
            items={[
              { label: "CenturyLink", href: "/providers/us/centurylink" }
            ]} 
          />
          ...
          <RelatedProviders currentCountryCode="us" currentProviderSlug="centurylink" />
        </div>
      </main>
