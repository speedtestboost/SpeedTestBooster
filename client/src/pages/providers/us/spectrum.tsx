...
export default function SpectrumSpeedTest() {
  ...
  useEffect(() => {
    document.title = "Spectrum Internet Speed Test - Test Charter Spectrum Cable Internet 2025";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Test your Spectrum internet speed for free. Check Charter Spectrum cable speeds up to 1 Gig, wifi performance, and connection quality across 41 states.');
    }

    const structuredData = {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Spectrum Internet Speed Test",
      "description": "Test your Spectrum internet speed for free. Check cable speeds up to 1 Gig.",
      "url": `${window.location.origin}/providers/us/spectrum`,
      "provider": {
        "@type": "Organization",
        "name": "Spectrum",
        "description": "Major cable internet provider serving 41 states across the United States",
        "areaServed": {
          "@type": "Country",
          "name": "United States"
        },
      ...
      <main className="max-w-7xl mx-auto px-4 lg:px-8 py-8 space-y-8">
        <div className="text-center space-y-6">
          <div className="flex items-center justify-center space-x-4">
            ...
            <div>
              <h1 className="text-4xl lg:text-6xl font-bold gradient-text">Spectrum</h1>
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-lg text-muted-foreground leading-relaxed">
              Test your Spectrum internet speed and performance. Check cable speeds, latency, and wifi quality across Spectrum's network serving 41 states.
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="card-hover">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-2xl font-bold text-primary">41 States</p>
          ...
          <Card className="card-hover">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">DOCSIS 3.1</p>
            </CardContent>
          </Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid md:grid-cols-3 gap-4">
              <div className="p-4 rounded-lg border border-border/50 space-y-2">
                ...
                <p className="text-2xl font-bold text-primary">300 Mbps</p>
                <p className="text-sm text-muted-foreground">Standard speed for most homes</p>
              </div>
              
              <div className="p-4 rounded-lg border border-border/50 space-y-2">
                <div className="flex items-center justify-between">
                  <h4 className="font-semibold">Internet Ultra</h4>
                  <Badge variant="default">Popular</Badge>
                </div>
                <p className="text-2xl font-bold text-primary">500 Mbps</p>
                <p className="text-sm text-muted-foreground">Great for streaming and gaming</p>
              </div>
              
              <div className="p-4 rounded-lg border border-border/50 space-y-2">
                <div className="flex items-center justify-between">
                  <h4 className="font-semibold">Internet Gig</h4>
                  <Badge variant="destructive">Premium</Badge>
                </div>
                <p className="text-2xl font-bold text-primary">1 Gig</p>
                <p className="text-sm text-muted-foreground">Maximum cable speed</p>
              </div>
            </div>
          </CardContent>
        </Card>
