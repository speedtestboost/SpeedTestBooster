...
export default function ComcastSpeedTest() {
  ...
  useEffect(() => {
    ...
    metaKeywords.setAttribute('content', 'xfinity speed test, comcast speed test, comcast xfinity speed test, xfinity internet speed test, comcast cable test, xfinity wifi speed test, comcast internet speed test, xfinity broadband test, comcast upload speed test, test xfinity speed, comcast cable internet test, xfinity gig speed test');

    const ogTags = [
      { property: 'og:title', content: 'Comcast Xfinity Speed Test USA - Free Cable Internet Speed Test 2025' },
      { property: 'og:description', content: 'Test Comcast Xfinity cable internet speed. Check download/upload speeds and ping. Accurate Xfinity speed test results.' },
    ...
    const twitterTags = [
      ...
      { name: 'twitter:title', content: 'Comcast Xfinity Speed Test USA - Free Cable Internet Speed Test 2025' },
      { name: 'twitter:description', content: 'Test Comcast Xfinity cable internet speed. Accurate Xfinity speed test for download, upload, and ping.' }
    ];
    ...
    const structuredData = {
      ...
      "@type": "WebPage",
      "name": "Comcast Xfinity Speed Test 2025",
      ...
      "mainEntity": {
        ...
        "name": "Comcast Xfinity Speed Test Tool",
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      ...
      <main className="pt-24 pb-12">
        <div className="max-w-4xl mx-auto px-4 lg:px-8">
          ...
          <Card className="mb-12 border-primary/20 bg-primary/5">
            <CardContent className="p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Pro Tip: Get the Most Accurate Xfinity Speed Test Results</h3>
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4 text-center">Understanding Your Comcast Xfinity Speed Test Results</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      For basic use, 100-200 Mbps works well. Multiple 4K streams and gaming require 300-500 Mbps. Heavy usage households benefit from Gigabit plans. Use our <Link href="/internet-speed-requirements" className="text-primary hover:underline">internet speed requirements calculator</Link> for personalized recommendations.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <footer className="bg-background/50 backdrop-blur-sm border-t border-border/20 mt-16">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12">
          ...
          <div className="text-center pt-8 border-t border-border/30 mt-8">
            <p className="text-sm text-muted-foreground">
              © 2025 Speed Test and Boost. Free Comcast Xfinity internet speed test. 
