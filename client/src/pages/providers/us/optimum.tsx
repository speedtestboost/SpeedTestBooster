...
export default function OptimumSpeedTest() {
  ...
  useEffect(() => {
    ...
    setCanonicalHref('https://speedtestboost.com/providers/us/optimum');
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      ...
      <main className="pt-24 pb-12">
        <div className="max-w-4xl mx-auto px-4 lg:px-8">
          <Breadcrumbs 
            items={[
              { label: "Optimum", href: "/providers/us/optimum" }
            ]} 
          />
          ...
          <RelatedProviders currentCountryCode="us" currentProviderSlug="optimum" />
        </div>
      </main>
