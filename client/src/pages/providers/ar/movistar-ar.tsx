...
export default function MovistarArgentinaSpeedTest() {
  ...
  useEffect(() => {
    document.title = "Movistar Speed Test - Test Movistar Fibra Internet Speed Argentina 2025";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Free Movistar speed test for fibra customers. Test Movistar internet speeds across Argentina. Check fiber download, upload speeds and ADSL performance.');
    }
