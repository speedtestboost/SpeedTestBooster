...
export default function EESpeedTest() {
  const [showSpeedTest, setShowSpeedTest] = useState(false);

  useEffect(() => {
    document.title = "EE Broadband Speed Test - Test EE 4G 5G Fibre Internet UK 2025";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Test your EE broadband speed for free. Check EE 4G, 5G, and fibre speeds across the UK.');
    }

    const structuredData = {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "EE Broadband Speed Test",
      "url": `${window.location.origin}/providers/uk/ee`,
      "provider": {
        "@type": "Organization",
        "name": "EE",
        "description": "UK mobile and broadband provider offering 4G, 5G, and fibre services",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <Header currentPath="/providers/uk/ee" />
      ...
      <main className="max-w-7xl mx-auto px-4 lg:px-8 py-8 space-y-8">
        <div className="text-center space-y-6">
          <div className="flex items-center justify-center space-x-4">
            ...
            <div>
              <h1 className="text-4xl lg:text-6xl font-bold gradient-text">EE</h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="card-hover">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-2xl font-bold text-primary">31M+</p>
            </CardContent>
          </Card>
        </div>
      </main>
