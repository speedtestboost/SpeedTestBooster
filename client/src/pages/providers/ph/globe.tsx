...
export default function GlobeSpeedTest() {
  ...
  useEffect(() => {
    ...
    canonical.href = 'https://speedtestboost.com/providers/ph/globe';
        ...
        <div className="max-w-4xl mx-auto px-4 lg:px-8">
          <Breadcrumbs 
            items={[
              ...
              { label: "Philippines", href: "/internet-providers" },
              { label: "Globe", href: "/providers/ph/globe" }
            ]} 
          />
          ...
          <RelatedProviders currentCountryCode="ph" currentProviderSlug="globe" />
        </div>
      </main>
