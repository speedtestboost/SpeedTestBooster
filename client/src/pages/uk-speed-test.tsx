...
export default function UKSpeedTest() {
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden lg:flex items-center space-x-6">
                ...
                <Link href="/us-speed-test" className="text-muted-foreground hover:text-primary transition-colors">
                  🇺🇸 USA
                </Link>
          ...
          {showMobileMenu && (
            <div className="lg:hidden mt-4 pt-4 border-t border-border/30">
              <div className="flex flex-col space-y-3">
                ...
                <Link href="/us-speed-test" className="text-muted-foreground hover:text-primary transition-colors py-2">
                  🇺🇸 USA Speed Test
                </Link>
          ...
          <div className="space-y-6">
            ...
            <Card className="card-hover">
              <CardContent className="p-6 space-y-4">
                <h3 className="text-lg font-semibold text-foreground">UK Broadband Test</h3>
                <Button
      ...
      <section className="bg-card/30 backdrop-blur-sm border-t border-border/50 mt-12">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            <Card className="card-hover">
              <CardContent className="p-6">
                <h2 className="text-lg font-semibold text-foreground mb-3">Broadband Speed Test UK</h2>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Test your broadband speed across the United Kingdom with our free online speed checker. 
                  Get accurate results for BT, Sky, Virgin Media, TalkTalk, Plusnet, and other major UK ISPs. 
                  Our UK servers provide precise measurements for fibre, ADSL, and WiFi connections.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="card-hover">
              <CardContent className="p-6">
                <h2 className="text-lg font-semibold text-foreground mb-3">Major UK Internet Providers</h2>
                <div className="space-y-2 text-sm text-muted-foreground">
                  <div><strong className="text-foreground">BT Fibre:</strong> Superfast fibre up to 67 Mbps</div>
                  <div><strong className="text-foreground">Sky Superfast:</strong> Fibre speeds up to 59 Mbps</div>
                  <div><strong className="text-foreground">Virgin Media:</strong> Cable speeds up to 1130 Mbps</div>
                  <div><strong className="text-foreground">TalkTalk:</strong> Fibre packages up to 67 Mbps</div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="card-hover">
              <CardContent className="p-6">
                <h2 className="text-lg font-semibold text-foreground mb-3">UK Speed Test Servers</h2>
                <div className="space-y-2 text-sm text-muted-foreground">
                  <div><strong className="text-foreground">England:</strong> London, Manchester, Birmingham</div>
                  <div><strong className="text-foreground">Scotland:</strong> Edinburgh, Glasgow</div>
                  <div><strong className="text-foreground">Wales:</strong> Cardiff, Swansea</div>
                  <div><strong className="text-foreground">N. Ireland:</strong> Belfast coverage</div>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="text-center">
            <h2 className="text-2xl font-bold text-foreground mb-6">Why Choose Our UK Broadband Test?</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-foreground mb-2">Accurate UK Measurements</h4>
                  <p className="text-sm text-muted-foreground">
                    Our speed test uses multiple UK-based servers to provide the most accurate broadband speed 
                    measurements for British users. Test your connection against servers across England, Scotland, Wales, and Northern Ireland.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-foreground mb-2">All Major UK ISPs Supported</h4>
                  <p className="text-sm text-muted-foreground">
                    Whether you're using BT, Sky, Virgin Media, TalkTalk, Plusnet, or any other UK internet provider, 
                    our test works with all networks including fibre, cable, and ADSL connections.
                  </p>
                </div>
              </div>
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="font-semibold text-foreground mb-2">Optimise Your UK Connection</h4>
                  <p className="text-sm text-muted-foreground">
                    Get personalised recommendations to improve your internet speed based on your UK location 
                    and ISP. Learn how to optimise your home network for better performance across the British Isles.
                  </p>
                </div>
              </div>
            </div>
